...
const Stategy = () => {
    return (
        <div className="pt-0 pb-24 lg:py-24 bg-[url(https://i.ibb.co.com/B4KrRyK/Bg.png)] bg-cover">
            <div className="flex justify-between max-w-[1280px] mx-auto lg:flex-row flex-col gap-y-3">
                <div className="">
                    <h2 className="text-5xl black uppercase font-medium leading-[1.2]">Our <br /> strategy <br /> approach</h2>
                    <p className="text-[#383838] font-medium text-xs w-72 leading-[1.8] mt-8">When you have the right foundation, your business will grow. Our agency combines website design and branding with the right online tools to accelerate your business success.</p>
                </div>
                <div className="">
                    <div className="flex border-b parent hover:-translate-x-1 delay-150 duration-300 transition py-5 border-gray-300">
                        ...
                        <div className="ml-7">
                            ...
                            <p className="no-black text-xs font-medium leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit, <br /> sed do eiusmod tempor incididunt ut labore.</p>
                        </div>
                    </div>
                    <div className="flex border-b parent hover:-translate-x-1 delay-150 duration-300 transition py-5 border-gray-300">
