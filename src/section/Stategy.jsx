        ...
        <div className="pt-0 pb-24 lg:py-24 bg-[url(https://i.ibb.co.com/B4KrRyK/Bg.png)] bg-cover">
            <div className="flex justify-between max-w-[1280px] mx-auto lg:flex-row flex-col gap-y-3 px-3">
                <div data-aos='fade-left'>
                    ...
                    <p className="text-[#383838] font-semibold text-[17px] w-72 leading-[1.8] mt-8">When you have the right foundation, your business will grow. Our agency combines website design and branding with the right online tools to accelerate your business success.</p>
                </div>
                <div data-aos='fade-right'>
                    <div className="flex border-b parent hover:-translate-x-1 delay-150 duration-300 transition py-5 border-gray-300">
                        ...
                        <div className="ml-7">
                            ...
                            <p className="no-black text-[17px] font-semibold leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit, <br /> sed do eiusmod tempor incididunt ut labore.</p>
                        </div>
                    </div>
                    <div className="flex border-b parent hover:-translate-x-1 delay-150 duration-300 transition py-5 border-gray-300">
